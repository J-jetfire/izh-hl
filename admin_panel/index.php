...
die; 
    ...
    require_once '../header/topper2.php';
die; 
} else if($_SESSION['usr']=='statist') {
    require_once 'iceapplink.php';
die;
}
...
//================================================================================
        ...
        if(!empty($_POST)){ // если пост данные не пустые, то выполняем код
            new_player($link, $_POST['img'], $_POST['sname'], $_POST['name'], $_POST['tname'], $_POST['pos'], $_POST['num'], $_POST['team'], $_POST['height'], $_POST['weight'], $_POST['hand'], $_POST['birthdate'], $idofcup); // функция добавления данных с запросами
            header('Location: data_add.php'); // перенаправление после успешного добавления данных
        }
