                    ...
                    <div class="row text-center">
                        <form name="addreview2" id="addreview2" action="">
                            <table id="table_changenum" style="height:200px;width:500px">
                                ...
                                <option value="Дисциплинарный штраф до конца игры">Дисциплинарный штраф до конца игры</option>
                                <option value="Драка">Драка</option>
                                <option value="Зачинщик драки">Зачинщик драки</option>
                                ...
                                <option value="Задержка соперника">Задержка соперника</option>
                                ...
                                <option value="Игра со сломанной клюшкой">Игра со сломанной клюшкой</option>
                                ...
                                <option value="Опасное снаряжение">Опасное снаряжение</option>
                                <option value="Оскорбление судей и неспортивное поведение">Оскорбление судей и неспортивное поведение</option>
                                <option value="Подножка">Подножка</option>
                                <option value="Попытка колящего удара">Попытка колящего удара</option>
                                ...
                                <option value="Малый скамеечный штраф">Малый скамеечный штраф</option>
                                <option value="Матч штраф">Матч штраф</option>
                                <option value="Направление осколков льда в лицо вратарю">Направление осколков льда в лицо вратарю</option>
                                <option value="Удар концом клюшки">Удар концом клюшки</option> 
                           </select></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" name="etcet" id=etc72 value=7><label for="etc72"class="goalstate" required="required">20</label></td>
                                        
                                        <td><input type="radio" name="etcet" id=etc92 value=9><label for="etc92"class="goalstate" required="required">2+2+10</label></td>
