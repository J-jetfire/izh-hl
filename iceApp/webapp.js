        ...
        if (document.getElementById("button" + i).style.backgroundColor == a) {
            ...
            if (j == true) {
                if (i >= 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/ajax_faceoff.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
...
function NoVBRALL(j) {
    if (confirm("Вы точно хотите отменить Вбрасывание игрокам?")) {
    var i = 0;
    var whowon = true;
    while (i < 60) {
        if (document.getElementById("button" + i).style.backgroundColor == a) {
            ...
            if (j == true) {
                if (i >= 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/delete_ajax_faceoff.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
    ...
    function NoVBR(j) {
        if (confirm("Вы точно хотите отменить Вбрасывание игроку?")) {
    var i = 0;
    var whowon = true;
    while (i < 60) {
        if (document.getElementById("button" + i).style.backgroundColor == a) {
        ...
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                if (i >= 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/ajax_penalty.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
    ...
    function NoPenalty(j) {
        if (confirm("Вы точно хотите убрать Штрафные минуты игроку?")) {
        var i = 0;
        var whowon = true;
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                if (i > 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/delete_ajax_penalty.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
    ...
    function NoGoal() {
        if (confirm("Вы точно хотите отменить ГОЛ игроку?")) {
        var i = 0;
    ...
    function GoalScore(redButton, boolGol) {
        ...
        if (redButton <= 29) {
            ...
            whowon = true;
                    $.ajax({
                        url: 'iceApp/online/ajax_goal.php',
                        type: 'POST',
                        data: {
                            id: identifiers[redButton],
                            prtk: protokol,
                            lostg: identifiers[gkeeperIDa],
                            whowon: whowon
                        }
                    });
            } else {
                ...
                whowon = true;
                    $.ajax({
                        url: 'iceApp/online/delete_ajax_goal.php',
                        type: 'POST',
                        data: {
                            id: identifiers[redButton],
                            prtk: protokol,
        ...
        document.getElementById("labelscore").innerHTML = score1 + " : " + score2;
 ...
 //   } //Фун. для паса++.
    function NoPas() {
        if (confirm("Вы точно хотите отменить передачи игроку(ам)?")) {
        var i = 0;
        var whowon = true;
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                whowon = false;
                    $.ajax({
                        url: 'iceApp/online/delete_ajax_assist.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
        ...
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                if (i >= 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/ajax_shot.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
        ...
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                if (i >= 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/ajax_bshot.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
...
function nobshot() {
        if (confirm("Вы точно хотите отменить Забл.Бросок игроку(ам)?")) {
        var i = 0;
        var whowon = true;
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                if (i >= 0 && i <= 29) {
                    ...
                    //
                     whowon = true;
                    $.ajax({
                        url: 'iceApp/online/delete_ajax_bshot.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
    ...
    function NoShot() {
        if (confirm("Вы точно хотите отменить Бросок игроку(ам)?")) {
        ...
        while (i < 60) {
            if (document.getElementById("button" + i).style.backgroundColor == a) {
                ...
                if (i >= 0 && i <= 29) {
                    ...
                    whowon = true;
                    $.ajax({
                        url: 'iceApp/online/delete_ajax_shot.php',
                        type: 'POST',
                        data: {
                            id: identifiers[i],
                            prtk: protokol,
    ...
    function period(j) {
        ...
        document.getElementById("tmpn1").style.backgroundColor = a;
            document.getElementById('tmpn1').style.color = c;
        }
        if (j == 2) {
            quarter = 3;
        ...
        document.getElementById('tmpn2').style.backgroundColor = a;
            document.getElementById('tmpn2').style.color = c;
        }
        if (j == 3) {
            quarter = 4;
        ...
        document.getElementById('tmpn3').style.backgroundColor = a;
            document.getElementById('tmpn3').style.color = c;
        }
        if (j == 4) {
            quarter = 5;
        ...
        document.getElementById('tmpn4').style.backgroundColor = a;
        document.getElementById('tmpn4').style.color = c;
        }
        if (j == 5) {
        ...
        document.getElementById('tmpn5').style.backgroundColor = a;
        document.getElementById('tmpn5').style.color = c;
        }
        if (j < 5) {
