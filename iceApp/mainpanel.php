<!-- PANEL WITH BUTTONS OF CONTROL & PLAYERS -->
    <section id="mainpanel">
        <div class="row" style="margin:0;padding:0;">
            ...
            <div class="col-xs-4 text-center" style="margin:0;padding:20px 0 0 0;">
                <div class="row" id="buttons">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
               <div class="row" id="buttons">
                   <hr>
                    <input type="button" value="1 пер." id="tmpn1" class="teampenalty" onclick=period(1)>
                    <input type="button" value="2 пер." id="tmpn2" class="teampenalty" onclick=period(2)>
                    <input type="button" value="3 пер." id="tmpn3" class="teampenalty" onclick=period(3)><br>
                    <input type="button" value="ОТ" id="tmpn4" class="teampenalty" onclick=period(4)>
                    <input type="button" value="Бул." id="tmpn5" class="teampenalty" onclick=period(5)>
                </div>
                <div class="row">
